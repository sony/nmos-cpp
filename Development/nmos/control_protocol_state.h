...
namespace nmos
{
    namespace experimental
    {
        ...
        struct control_protocol_state
        {
            ...
            control_protocol_state(control_protocol_property_changed_handler property_changed = nullptr, filter_property_value_holders_handler filter_property_value_holders = nullptr, modify_rebuildable_block_handler modify_rebuildable_block = nullptr);

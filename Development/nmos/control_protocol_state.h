...
namespace nmos
{
    namespace experimental
    {
        ...
        struct control_protocol_state
        {
            ...
            control_protocol_state(get_lost_packet_counters_handler get_lost_packet_counters = nullptr, get_late_packet_counters_handler get_late_packet_counters = nullptr, reset_counters_handler reset_counters = nullptr, control_protocol_property_changed_handler property_changed = nullptr);

...
namespace nmos
{
    namespace experimental
    {
        ...
        struct control_protocol_state
        {
            ...
            control_protocol_state(control_protocol_property_changed_handler property_changed = nullptr, get_read_only_modification_allow_list_handler get_read_only_modification_allow_list = nullptr, remove_device_model_object_handler remove_device_model_object = nullptr, create_device_model_object_handler create_device_model_object = nullptr);

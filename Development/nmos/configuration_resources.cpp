...
namespace nmos
{
    ...
    {
        return nc::details::make_object_properties_set_validation(role_path, status, notices, web::json::value::string(status_message));
    }
    ...
    {
        return nc::details::make_object_properties_set_validation(role_path, status, notices, web::json::value::null());
    }
    ...
    {
        return nc::details::make_object_properties_set_validation(role_path, status, web::json::value::array().as_array(), web::json::value::null());
    }
    ...
    {
        return nc::details::make_object_properties_set_validation(role_path, status, web::json::value::array().as_array(), web::json::value::string(status_message));
    }
}

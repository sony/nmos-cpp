...
namespace nmos
{
    ...
    namespace details
    {
        ...
        // Set appropriate transport parameters based on the parsed SDP file 
        void merge_session_description(web::json::value& transport_params, const web::json::value& session_description)
        {
            using web::json::value;
            ...
            for (size_t leg = 0; leg < transport_params.size(); ++leg)
            {
                ...
                {
                    set_multicast_ip_interface_ip(params, connection_base_address(sdp::fields::connection_address(session_connection_data)));
                }
                ...
                for (auto md = mda.begin(); mda.end() != md; ++md)
                {
                    ...
                    if (!media_attributes.is_null())
                    {
                        ...
                        if (ma.end() != source_filter)
                        {
                            ...
                            set_multicast_ip_interface_ip(params, sdp::fields::destination_address(sf));
                    ...
                    if (0 != mcda.size())
                    {
                        ...
                        set_multicast_ip_interface_ip(params, connection_base_address(sdp::fields::connection_address(media_connection_data)));
                    }
        ...
        void merge_transport_file(web::json::value& transport_params, const utility::string_t& transport_data, const utility::string_t& transport_type)
        {
            ...
            try
            {
                ...
                details::merge_session_description(transport_params, session_description);
            }

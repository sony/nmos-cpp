...
namespace nmos
{
    ...
    void add_api_finally_handler(web::http::experimental::listener::api_router& api, const web::http::experimental::htst& htst, slog::base_gate& gate);
    ...
    void support_api(web::http::experimental::listener::http_listener& listener, web::http::experimental::listener::api_router api, const web::http::experimental::htst& htst, slog::base_gate& gate);
    ...
    namespace details
    {
        ...
        web::http::experimental::listener::route_handler make_api_finally_handler(const web::http::experimental::htst& htst, slog::base_gate& gate);
    }
}

...
namespace nmos
{
    namespace details
    {
        ...
        web::json::value find_property_descriptor(const nc_property_id& property_id, const nc_class_id& class_id_, get_control_protocol_class_descriptor_handler get_control_protocol_class_descriptor, const get_property_descriptors_handler& get_property_descriptors)
        {
            using web::json::value;
            ...
            while (!class_id.empty())
            {
                ...
                const auto& property_descriptors = get_property_descriptors(control_class);
    ...
    {
        return details::find_property_descriptor(property_id, class_id_, get_control_protocol_class_descriptor, [](const nmos::experimental::control_class_descriptor& class_descriptor) { return class_descriptor.property_descriptors; });
    }
    ...
    {
        return details::find_property_descriptor(property_id, class_id_, get_control_protocol_class_descriptor, [](const nmos::experimental::control_class_descriptor& class_descriptor) { return class_descriptor.decorated_property_descriptors; });
    }

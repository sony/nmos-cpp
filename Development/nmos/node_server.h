...
namespace nmos
{
    ...
    namespace experimental
    {
        ...
        struct node_implementation
        {
            ...
            node_implementation& on_load_client_certificate(nmos::load_client_certificate_handler load_client_certificate) { this->load_client_certificate = std::move(load_client_certificate); return *this; }
            ...
            node_implementation& on_ca_certificate_received(nmos::experimental::receive_ca_certificate_handler ca_certificate_received) { this->ca_certificate_received = std::move(ca_certificate_received); return *this; }
            node_implementation& on_rsa_server_certificate_received(nmos::experimental::receive_server_certificate_handler rsa_server_certificate_received) { this->rsa_server_certificate_received = std::move(rsa_server_certificate_received); return *this; }
            node_implementation& on_ecdsa_server_certificate_received(nmos::experimental::receive_server_certificate_handler ecdsa_server_certificate_received) { this->ecdsa_server_certificate_received = std::move(ecdsa_server_certificate_received); return *this; }

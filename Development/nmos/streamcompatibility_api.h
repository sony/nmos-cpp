...
namespace nmos
{
    ...
    namespace experimental
    {
        namespace details
        {
            ...
            // or std::runtime_error, which will be mapped to a 500 Internal Error status code with NMOS error "debug" information including the exception message
            typedef std::function<void(const nmos::resource& streamcompatibility_sender, const web::json::value& constraint_sets, web::json::value& intersection)> streamcompatibility_active_constraints_put_handler;

...
namespace nmos
{
    ...
    {
        auto data = details::make_receiver_monitor(nc_receiver_monitor_class_id, oid, constant_oid, owner, role, user_label, description, touchpoints, runtime_property_constraints, enabled, overall_status, overall_status_message, link_status, link_status_message, connection_status, connection_status_message, synchronization_status, synchronization_status_message, synchronization_source_id, synchronization_source_changes, stream_status, stream_status_message, status_reporting_delay, auto_reset_packet_counters, auto_reset_synchronization_source_changes);

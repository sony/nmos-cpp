...
namespace nmos
{
    namespace nc
    {
        ...
        web::json::value get(const nmos::resource& resource, const web::json::value& arguments, bool is_deprecated, get_control_protocol_class_descriptor_handler get_control_protocol_class_descriptor, slog::base_gate& gate)
        {
            ...
            const auto& property = nc::find_property_descriptor(nmos::details::parse_nc_property_id(property_id), nmos::details::parse_nc_class_id(nmos::fields::nc::class_id(resource.data)), get_control_protocol_class_descriptor);
            if (!property.is_null())
            {
                return nmos::details::make_nc_method_result({is_deprecated ? nmos::nc_method_status::method_deprecated : nmos::fields::nc::is_deprecated(property) ? nc_method_status::property_deprecated : nc_method_status::ok}, resource.data.at(nmos::fields::nc::name(property)));
            }
            ...
            return nmos::details::make_nc_method_result_error({nc_method_status::property_not_implemented}, ss.str());
        }
        ...
        web::json::value set(nmos::resources& resources, const nmos::resource& resource, const web::json::value& arguments, bool is_deprecated, get_control_protocol_class_descriptor_handler get_control_protocol_class_descriptor, get_control_protocol_datatype_descriptor_handler get_control_protocol_datatype_descriptor, control_protocol_property_changed_handler property_changed, slog::base_gate& gate)
        {
            ...
            // find the relevant nc_property_descriptor
            const auto property_id_ = nmos::details::parse_nc_property_id(property_id);
            const auto& property = nc::find_property_descriptor(property_id_, nmos::details::parse_nc_class_id(nmos::fields::nc::class_id(resource.data)), get_control_protocol_class_descriptor);
            if (!property.is_null())
            {
                if (nmos::fields::nc::is_read_only(property))
                {
                    ...
                    slog::log<slog::severities::error>(gate, SLOG_FLF) << ss.str();
                    return nmos::details::make_nc_method_result_error({nc_method_status::read_only}, ss.str());
                }
                    ...
                    || (val.is_array() && !nmos::fields::nc::is_sequence(property)))
                {
                    ...
                    slog::log<slog::severities::error>(gate, SLOG_FLF) << ss.str();
                    return nmos::details::make_nc_method_result_error({nc_method_status::parameter_error}, ss.str());
                }
                ...
                if (nmos::fields::nc::name(property).c_str() == nmos::fields::nc::enabled.key
                    && nc::is_status_monitor(nmos::details::parse_nc_class_id(nmos::fields::nc::class_id(resource.data)))
                    && !val.as_bool())
                {
                    utility::ostringstream_t ss;
                    ss << U("invalid request: cannot disable NcStatusMonitors");
                    slog::log<slog::severities::error>(gate, SLOG_FLF) << ss.str();
                    return nmos::details::make_nc_method_result_error({nc_method_status::invalid_request}, ss.str());
                }
                ...
                try
                {
                    ...
                    return nmos::details::make_nc_method_result({is_deprecated ? nmos::nc_method_status::method_deprecated : nmos::fields::nc::is_deprecated(property) ? nc_method_status::property_deprecated : nc_method_status::ok});
                }
        ...
        web::json::value get_sequence_item(const nmos::resource& resource, const web::json::value& arguments, bool is_deprecated, get_control_protocol_class_descriptor_handler get_control_protocol_class_descriptor, slog::base_gate& gate)
        {
            ...
            if (!property.is_null())
            {
                ...
                {
                    return nmos::details::make_nc_method_result({is_deprecated ? nmos::nc_method_status::method_deprecated : nmos::fields::nc::is_deprecated(property) ? nc_method_status::property_deprecated : nc_method_status::ok}, data.at(index));
                }
                ...
                slog::log<slog::severities::error>(gate, SLOG_FLF) << ss.str();
                return nmos::details::make_nc_method_result_error({nc_method_status::index_out_of_bounds}, ss.str());
            }
        ...
        web::json::value set_sequence_item(nmos::resources& resources, const nmos::resource& resource, const web::json::value& arguments, bool is_deprecated, get_control_protocol_class_descriptor_handler get_control_protocol_class_descriptor, get_control_protocol_datatype_descriptor_handler get_control_protocol_datatype_descriptor, control_protocol_property_changed_handler property_changed, slog::base_gate& gate)
        {
            ...
            if (!property.is_null())
            {
                if (nmos::fields::nc::is_read_only(property))
                {
                    return  nmos::details::make_nc_method_result({nc_method_status::read_only});
                }
        ...
        web::json::value add_sequence_item(nmos::resources& resources, const nmos::resource& resource, const web::json::value& arguments, bool is_deprecated, get_control_protocol_class_descriptor_handler get_control_protocol_class_descriptor, get_control_protocol_datatype_descriptor_handler get_control_protocol_datatype_descriptor, control_protocol_property_changed_handler property_changed, slog::base_gate& gate)
        {
            ...
            if (!property.is_null())
            {
                ...
                try
                {
                    ...
                    return nmos::details::make_nc_method_result({is_deprecated ? nmos::nc_method_status::method_deprecated : nmos::fields::nc::is_deprecated(property) ? nc_method_status::property_deprecated : nc_method_status::ok}, sequence_item_index);
                }
                catch (const nmos::control_protocol_exception& e)
                {
                    utility::ostringstream_t ss;
        ...
        web::json::value remove_sequence_item(nmos::resources& resources, const nmos::resource& resource, const web::json::value& arguments, bool is_deprecated, get_control_protocol_class_descriptor_handler get_control_protocol_class_descriptor, control_protocol_property_changed_handler property_changed, slog::base_gate& gate)
        {
            ...
            if (!property.is_null())
            {
                ...
                if (data.as_array().size() > (size_t)index)
                {
                    ...
                    }, make_property_changed_event(nmos::fields::nc::oid(resource.data), {{nmos::details::parse_nc_property_id(property_id), nc_property_change_type::type::sequence_item_removed, nc_id(index)}}));
        ...
        web::json::value get_sequence_length(const nmos::resource& resource, const web::json::value& arguments, bool is_deprecated, get_control_protocol_class_descriptor_handler get_control_protocol_class_descriptor, slog::base_gate& gate)
        {
            ...
            if (!property.is_null())
            {
                ...
                if (nmos::fields::nc::is_nullable(property))
                {
                    ...
                    {
                        // null
                        return nmos::details::make_nc_method_result({is_deprecated ? nmos::nc_method_status::method_deprecated : nmos::fields::nc::is_deprecated(property) ? nc_method_status::property_deprecated : nc_method_status::ok}, value::null());
                    }
                }
                else
                {
                ...
                return nmos::details::make_nc_method_result({is_deprecated ? nmos::nc_method_status::method_deprecated : nmos::fields::nc::is_deprecated(property) ? nc_method_status::property_deprecated : nc_method_status::ok}, value(uint32_t(data.as_array().size())));
            }
        ...
        web::json::value get_member_descriptors(nmos::resources& resources, const nmos::resource& resource, const web::json::value& arguments, bool is_deprecated, slog::base_gate& gate)
        {
            ...
            return nmos::details::make_nc_method_result({is_deprecated ? nmos::nc_method_status::method_deprecated : nc_method_status::ok}, descriptors);
        }
        ...
        web::json::value find_members_by_path(nmos::resources& resources, const nmos::resource& resource_, const web::json::value& arguments, bool is_deprecated, slog::base_gate& gate)
        {
            ...
            {
                // empty path
                return nmos::details::make_nc_method_result_error({nc_method_status::parameter_error}, U("empty path to do FindMembersByPath"));
            }
        ...
        web::json::value find_members_by_role(nmos::resources& resources, const nmos::resource& resource, const web::json::value& arguments, bool is_deprecated, slog::base_gate& gate)
        {
            ...
            {
                // empty role
                return nmos::details::make_nc_method_result_error({nc_method_status::parameter_error}, U("empty role to do FindMembersByRole"));
            }
        ...
        web::json::value find_members_by_class_id(nmos::resources& resources, const nmos::resource& resource, const web::json::value& arguments, bool is_deprecated, slog::base_gate& gate)
        {
            ...
            const auto class_id = nmos::details::parse_nc_class_id(nmos::fields::nc::class_id(arguments)); // Class id to search for
            ...
            {
                // empty class_id
                return nmos::details::make_nc_method_result_error({nc_method_status::parameter_error}, U("empty classId to do FindMembersByClassId"));
            }
        ...
        web::json::value get_control_class(const web::json::value& arguments, bool is_deprecated, get_control_protocol_class_descriptor_handler get_control_protocol_class_descriptor, slog::base_gate& gate)
        {
            ...
            {
                // empty class_id
                return nmos::details::make_nc_method_result_error({nc_method_status::parameter_error}, U("empty classId to do GetControlClass"));
            }
            ...
            if (!control_class.class_id.empty())
            {
                ...
                const auto descriptor = fixed_role.is_null()
                    ? nmos::details::make_nc_class_descriptor(description, class_id, name, property_descriptors, method_descriptors, event_descriptors)
                    : nmos::details::make_nc_class_descriptor(description, class_id, name, fixed_role.as_string(), property_descriptors, method_descriptors, event_descriptors);

                return nmos::details::make_nc_method_result({is_deprecated ? nmos::nc_method_status::method_deprecated : nc_method_status::ok}, descriptor);
            }

            return nmos::details::make_nc_method_result_error({nc_method_status::parameter_error}, U("classId not found"));
        }
        ...
        web::json::value get_datatype(const web::json::value& arguments, bool is_deprecated, get_control_protocol_datatype_descriptor_handler get_control_protocol_datatype_descriptor, slog::base_gate& gate)
        {
            ...
            {
                // empty name
                return nmos::details::make_nc_method_result_error({nc_method_status::parameter_error}, U("empty name to do GetDatatype"));
            }
            ...
            return nmos::details::make_nc_method_result_error({nc_method_status::parameter_error}, U("name not found"));
        }
        ...
        web::json::value reset_monitor(nmos::resources& resources, const nmos::resource& resource, const web::json::value&, bool is_deprecated, get_control_protocol_class_descriptor_handler get_control_protocol_class_descriptor, control_protocol_property_changed_handler property_changed, reset_monitor_handler reset_monitor, slog::base_gate& gate)
        {
            ...
            {
                const auto& property = nc::find_property_descriptor(property_value.first, nmos::details::parse_nc_class_id(nmos::fields::nc::class_id(resource.data)), get_control_protocol_class_descriptor);
                if (!property.is_null())
                {
                    try
                    {
                    ...
                    {
                        utility::ostringstream_t ss;
                        ss << "Reset counters: " << nmos::details::make_nc_property_id(property_value.first).serialize() << " error: " << e.what();
                        slog::log<slog::severities::error>(gate, SLOG_FLF) << ss.str();
                        return nmos::details::make_nc_method_result_error({nc_method_status::parameter_error}, ss.str());
                    }
                }

...
namespace nmos
{
    ...
    namespace experimental
    {
        namespace details
        {
            typedef std::function<nmos::sender_state(const web::json::value& transport_file, const web::json::value& sender, const web::json::value& flow, const web::json::value& source, const web::json::array& constraint_sets)> streamcompatibility_sender_validator;
        }

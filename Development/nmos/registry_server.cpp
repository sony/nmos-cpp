...
namespace nmos
{
    ...
    namespace experimental
    {
        ...
        nmos::server make_registry_server(nmos::registry_model& registry_model, nmos::experimental::registry_implementation registry_implementation, nmos::experimental::log_model& log_model, slog::base_gate& gate)
        {
            ...
            auto http_config = nmos::make_http_listener_config(registry_model.settings, registry_implementation.load_tls, registry_implementation.load_dh_param);
            ...
            auto websocket_config = nmos::make_websocket_listener_config(registry_model.settings, registry_implementation.load_tls, registry_implementation.load_dh_param);

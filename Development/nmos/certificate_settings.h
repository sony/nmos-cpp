...
namespace nmos
{
    namespace experimental
    {
        namespace fields
        {
            ...
            // key_algorithm (attribute of server_certificate_chains objects): name of the key algorithm for the certificate, see nmos::key_algorithm
            const web::json::field_as_string_or key_algorithm{ U("key_algorithm"), U("") };

            // private_key_file (attribute of server_certificate_chains objects): full path of private key file in PEM format
            const web::json::field_as_string_or private_key_file{ U("private_key_file"), U("") };

            // certificate_chain_file (attribute of server_certificate_chains objects): full path of server certificate chain file in PEM format, which must be sorted
            ...
            // (deprecated, replaced by server_certificate_chains)

...
BST_TEST_CASE(testApplyBackupDataSet)
{
    ...
    // callback stubs
    nmos::modify_read_only_config_properties_handler modify_read_only_config_properties = [&](nmos::experimental::control_protocol_state& control_protocol_state, nmos::get_control_protocol_class_descriptor_handler get_control_protocol_class_descriptor, const web::json::value& target_role_path, const web::json::value& object_properties_holders, bool recurse, const web::json::value& restore_mode, bool validate)
        {
    ...
    nmos::modify_rebuildable_block_handler modify_rebuildable_block = [&](nmos::experimental::control_protocol_state& control_protocol_state, nmos::get_control_protocol_class_descriptor_handler get_control_protocol_class_descriptor, const web::json::value& target_role_path, const web::json::value& property_values, bool recurse, const web::json::value& restore_mode, bool validate)
        {
...

    {
        ...
        value output = nmos::apply_backup_data_set(resources, control_protocol_state, get_control_protocol_class_descriptor, *resource, object_properties_holders.as_array(), recurse, restore_mode, validate, modify_read_only_config_properties, modify_rebuildable_block);

...
BST_TEST_CASE(testGetSetControlProtocolProperty)
{
	...
	auto oid = nmos::nc::get_control_protocol_property(resources, class_manager_oid, nmos::nc_object_oid_property_id, get_control_protocol_class_descriptor, gate);

	BST_CHECK_EQUAL(class_manager_oid, static_cast<uint32_t>(oid.as_integer()));

	auto role = nmos::nc::get_control_protocol_property(resources, class_manager_oid, nmos::nc_object_role_property_id, get_control_protocol_class_descriptor, gate);

	BST_CHECK_EQUAL(U("ClassManager"), role.as_string());

    auto test_label = U("ThisIsATest");

	bool result = nmos::nc::set_control_protocol_property_and_notify(resources, class_manager_oid, nmos::nc_object_user_label_property_id, web::json::value::string(test_label), get_control_protocol_class_descriptor, gate);

	BST_REQUIRE(result);

	auto label = nmos::nc::get_control_protocol_property(resources, class_manager_oid, nmos::nc_object_user_label_property_id, get_control_protocol_class_descriptor, gate);
...
BST_TEST_CASE(testSetReceiverMonitorStatuses)
{
...

    {
        ...
        auto actual_link_status = nmos::nc::get_control_protocol_property(resources, monitor_oid, nmos::nc_receiver_monitor_link_status_property_id, get_control_protocol_class_descriptor, gate);
        BST_CHECK_EQUAL(link_status, actual_link_status.as_integer());
        auto actual_link_status_message = nmos::nc::get_control_protocol_property(resources, monitor_oid, nmos::nc_receiver_monitor_link_status_message_property_id, get_control_protocol_class_descriptor, gate);
        BST_CHECK_EQUAL(link_status_message, actual_link_status_message.as_string());
        auto actual_link_status_transition_counter = nmos::nc::get_control_protocol_property(resources, monitor_oid, nmos::nc_receiver_monitor_link_status_transition_counter_property_id, get_control_protocol_class_descriptor, gate);
        BST_CHECK_EQUAL(expected_link_status_transition_counter, actual_link_status_transition_counter.as_integer());
        auto actual_connection_status = nmos::nc::get_control_protocol_property(resources, monitor_oid, nmos::nc_receiver_monitor_connection_status_property_id, get_control_protocol_class_descriptor, gate);
        BST_CHECK_EQUAL(connection_status, actual_connection_status.as_integer());
        auto actual_connection_status_message = nmos::nc::get_control_protocol_property(resources, monitor_oid, nmos::nc_receiver_monitor_connection_status_message_property_id, get_control_protocol_class_descriptor, gate);
        BST_CHECK_EQUAL(connection_status_message, actual_connection_status_message.as_string());
        auto actual_connection_status_transition_counter = nmos::nc::get_control_protocol_property(resources, monitor_oid, nmos::nc_receiver_monitor_connection_status_transition_counter_property_id, get_control_protocol_class_descriptor, gate);
        BST_CHECK_EQUAL(expected_connection_status_transition_counter, actual_connection_status_transition_counter.as_integer());
        auto actual_external_synchronization_status = nmos::nc::get_control_protocol_property(resources, monitor_oid, nmos::nc_receiver_monitor_external_synchronization_status_property_id, get_control_protocol_class_descriptor, gate);
        BST_CHECK_EQUAL(external_synchronization_status, actual_external_synchronization_status.as_integer());
        auto actual_external_synchronization_status_message = nmos::nc::get_control_protocol_property(resources, monitor_oid, nmos::nc_receiver_monitor_external_synchronization_status_message_property_id, get_control_protocol_class_descriptor, gate);
        BST_CHECK_EQUAL(external_synchronization_status_message, actual_external_synchronization_status_message.as_string());
        auto actual_external_synchronization_status_transition_counter = nmos::nc::get_control_protocol_property(resources, monitor_oid, nmos::nc_receiver_monitor_external_synchronization_status_transition_counter_property_id, get_control_protocol_class_descriptor, gate);
        ...
        auto actual_stream_status = nmos::nc::get_control_protocol_property(resources, monitor_oid, nmos::nc_receiver_monitor_stream_status_property_id, get_control_protocol_class_descriptor, gate);
        BST_CHECK_EQUAL(stream_status, actual_stream_status.as_integer());
        auto actual_stream_status_message = nmos::nc::get_control_protocol_property(resources, monitor_oid, nmos::nc_receiver_monitor_stream_status_message_property_id, get_control_protocol_class_descriptor, gate);
        BST_CHECK_EQUAL(stream_status_message, actual_stream_status_message.as_string());
        auto actual_stream_status_transition_counter = nmos::nc::get_control_protocol_property(resources, monitor_oid, nmos::nc_receiver_monitor_stream_status_transition_counter_property_id, get_control_protocol_class_descriptor, gate);
        BST_CHECK_EQUAL(expected_stream_status_transition_counter, actual_stream_status_transition_counter.as_integer());

        auto overall_status = nmos::nc::get_control_protocol_property(resources, monitor_oid, nmos::nc_status_monitor_overall_status_property_id, get_control_protocol_class_descriptor, gate);
...
BST_TEST_CASE(testSetSynchronizationSourceId)
{
...

    {
        ...
        auto actual_sync_source_id = nmos::nc::get_control_protocol_property(resources, monitor_oid, nmos::nc_receiver_monitor_synchronization_source_id_property_id, get_control_protocol_class_descriptor, gate);
...
BST_TEST_CASE(testActivateDeactivateReceiverMonitor)
{
...

    {
        ...
        nmos::nc::set_control_protocol_property_and_notify(resources, monitor_oid, nmos::nc_receiver_monitor_auto_reset_monitor_property_id, web::json::value::boolean(true), get_control_protocol_class_descriptor, gate);

        uint32_t transition_count = 10;
        // set transition counters
        nmos::nc::set_control_protocol_property_and_notify(resources, monitor_oid, nmos::nc_receiver_monitor_link_status_transition_counter_property_id, web::json::value::number(transition_count), get_control_protocol_class_descriptor, gate);
        nmos::nc::set_control_protocol_property_and_notify(resources, monitor_oid, nmos::nc_receiver_monitor_connection_status_transition_counter_property_id, web::json::value::number(transition_count), get_control_protocol_class_descriptor, gate);
        nmos::nc::set_control_protocol_property_and_notify(resources, monitor_oid, nmos::nc_receiver_monitor_external_synchronization_status_transition_counter_property_id, web::json::value::number(transition_count), get_control_protocol_class_descriptor, gate);
        nmos::nc::set_control_protocol_property_and_notify(resources, monitor_oid, nmos::nc_receiver_monitor_stream_status_transition_counter_property_id, web::json::value::number(transition_count), get_control_protocol_class_descriptor, gate);
        ...
        auto actual_overall_status = nmos::nc::get_control_protocol_property(resources, monitor_oid, nmos::nc_status_monitor_overall_status_property_id, get_control_protocol_class_descriptor, gate);
    ...
    }
    {
        ...
        nmos::nc::set_control_protocol_property_and_notify(resources, monitor_oid, nmos::nc_receiver_monitor_auto_reset_monitor_property_id, web::json::value::boolean(false), get_control_protocol_class_descriptor, gate);
...
BST_TEST_CASE(testSetSenderMonitorStatuses)
{
...

    {
        ...
        auto actual_link_status = nmos::nc::get_control_protocol_property(resources, monitor_oid, nmos::nc_sender_monitor_link_status_property_id, get_control_protocol_class_descriptor, gate);
        BST_CHECK_EQUAL(link_status, actual_link_status.as_integer());
        auto actual_link_status_message = nmos::nc::get_control_protocol_property(resources, monitor_oid, nmos::nc_sender_monitor_link_status_message_property_id, get_control_protocol_class_descriptor, gate);
        BST_CHECK_EQUAL(link_status_message, actual_link_status_message.as_string());
        auto actual_link_status_transition_counter = nmos::nc::get_control_protocol_property(resources, monitor_oid, nmos::nc_sender_monitor_link_status_transition_counter_property_id, get_control_protocol_class_descriptor, gate);
        BST_CHECK_EQUAL(expected_link_status_transition_counter, actual_link_status_transition_counter.as_integer());
        auto actual_transmission_status = nmos::nc::get_control_protocol_property(resources, monitor_oid, nmos::nc_sender_monitor_transmission_status_property_id, get_control_protocol_class_descriptor, gate);
        BST_CHECK_EQUAL(transmission_status, actual_transmission_status.as_integer());
        auto actual_transmission_status_message = nmos::nc::get_control_protocol_property(resources, monitor_oid, nmos::nc_sender_monitor_transmission_status_message_property_id, get_control_protocol_class_descriptor, gate);
        BST_CHECK_EQUAL(transmission_status_message, actual_transmission_status_message.as_string());
        auto actual_transmission_status_transition_counter = nmos::nc::get_control_protocol_property(resources, monitor_oid, nmos::nc_sender_monitor_transmission_status_transition_counter_property_id, get_control_protocol_class_descriptor, gate);
        BST_CHECK_EQUAL(expected_transmission_status_transition_counter, actual_transmission_status_transition_counter.as_integer());
        auto actual_external_synchronization_status = nmos::nc::get_control_protocol_property(resources, monitor_oid, nmos::nc_sender_monitor_external_synchronization_status_property_id, get_control_protocol_class_descriptor, gate);
        BST_CHECK_EQUAL(external_synchronization_status, actual_external_synchronization_status.as_integer());
        auto actual_external_synchronization_status_message = nmos::nc::get_control_protocol_property(resources, monitor_oid, nmos::nc_sender_monitor_external_synchronization_status_message_property_id, get_control_protocol_class_descriptor, gate);
        BST_CHECK_EQUAL(external_synchronization_status_message, actual_external_synchronization_status_message.as_string());
        auto actual_external_synchronization_status_transition_counter = nmos::nc::get_control_protocol_property(resources, monitor_oid, nmos::nc_sender_monitor_external_synchronization_status_transition_counter_property_id, get_control_protocol_class_descriptor, gate);
        BST_CHECK_EQUAL(expected_external_synchronization_status_transition_counter, actual_external_synchronization_status_transition_counter.as_integer());
        auto actual_essence_status = nmos::nc::get_control_protocol_property(resources, monitor_oid, nmos::nc_sender_monitor_essence_status_property_id, get_control_protocol_class_descriptor, gate);
        BST_CHECK_EQUAL(essence_status, actual_essence_status.as_integer());
        auto actual_essence_status_message = nmos::nc::get_control_protocol_property(resources, monitor_oid, nmos::nc_sender_monitor_essence_status_message_property_id, get_control_protocol_class_descriptor, gate);
        BST_CHECK_EQUAL(essence_status_message, actual_essence_status_message.as_string());
        auto actual_essence_status_transition_counter = nmos::nc::get_control_protocol_property(resources, monitor_oid, nmos::nc_sender_monitor_essence_status_transition_counter_property_id, get_control_protocol_class_descriptor, gate);
...
BST_TEST_CASE(testActivateDeactivateSenderMonitor)
{
    ...
    {
        // autoResetCounterAndMessages will reset all counters and messages on activate, including calling back into application code
        nmos::nc::set_control_protocol_property_and_notify(resources, monitor_oid, nmos::nc_sender_monitor_auto_reset_monitor_property_id, web::json::value::boolean(true), get_control_protocol_class_descriptor, gate);

        uint32_t transition_count = 10;
        // set transition counters
        nmos::nc::set_control_protocol_property_and_notify(resources, monitor_oid, nmos::nc_sender_monitor_link_status_transition_counter_property_id, web::json::value::number(transition_count), get_control_protocol_class_descriptor, gate);
        nmos::nc::set_control_protocol_property_and_notify(resources, monitor_oid, nmos::nc_sender_monitor_transmission_status_transition_counter_property_id, web::json::value::number(transition_count), get_control_protocol_class_descriptor, gate);
        nmos::nc::set_control_protocol_property_and_notify(resources, monitor_oid, nmos::nc_sender_monitor_external_synchronization_status_transition_counter_property_id, web::json::value::number(transition_count), get_control_protocol_class_descriptor, gate);
        nmos::nc::set_control_protocol_property_and_notify(resources, monitor_oid, nmos::nc_sender_monitor_essence_status_transition_counter_property_id, web::json::value::number(transition_count), get_control_protocol_class_descriptor, gate);
    ...
    }
    {
        ...
        // disable autoResetCounterAndMessages
        nmos::nc::set_control_protocol_property_and_notify(resources, monitor_oid, nmos::nc_sender_monitor_auto_reset_monitor_property_id, web::json::value::boolean(false), get_control_protocol_class_descriptor, gate);
...
BST_TEST_CASE(testSetMonitorStatusWithDelay)
{
...

    {
        ...
        nmos::nc::set_control_protocol_property(resources, monitor_oid, nmos::fields::nc::stream_status, 1, gate);
        ...
        const auto actual_value = nmos::nc::get_control_protocol_property(resources, monitor_oid, nmos::fields::nc::stream_status, gate);
    ...
    }
    {
        ...
        nmos::nc::set_control_protocol_property(resources, monitor_oid, nmos::fields::nc::monitor_activation_time, 0, gate);
        nmos::nc::set_control_protocol_property(resources, monitor_oid, nmos::fields::nc::stream_status, 1, gate);
        ...
        const auto actual_time = nmos::nc::get_control_protocol_property(resources, monitor_oid, nmos::fields::nc::stream_status_pending_received_time, gate);
    ...
    }
    {
        ...
        const auto actual_status = nmos::nc::get_control_protocol_property(resources, monitor_oid, nmos::fields::nc::stream_status_pending, gate);
    ...
    }
    {
        ...
        nmos::nc::set_control_protocol_property(resources, monitor_oid, nmos::fields::nc::monitor_activation_time, 0, gate);
        nmos::nc::set_control_protocol_property(resources, monitor_oid, nmos::fields::nc::stream_status, 2, gate);
    ...
    }
    {
        ...
        nmos::nc::set_control_protocol_property(resources, monitor_oid, nmos::fields::nc::monitor_activation_time, 0, gate);
        nmos::nc::set_control_protocol_property(resources, monitor_oid, nmos::fields::nc::stream_status, initial_status, gate);
    ...
    }
    {
        ...
        nmos::nc::set_control_protocol_property(resources, monitor_oid, nmos::fields::nc::stream_status_pending, expected_status, gate);
        nmos::nc::set_control_protocol_property(resources, monitor_oid, nmos::fields::nc::stream_status_pending_received_time, received_time, gate);
    ...
    }
    {
        ...
        nmos::nc::set_control_protocol_property(resources, monitor_oid, nmos::fields::nc::monitor_activation_time, 0, gate);
        nmos::nc::set_control_protocol_property(resources, monitor_oid, nmos::fields::nc::stream_status, initial_status, gate);
        nmos::nc::set_control_protocol_property(resources, monitor_oid, nmos::fields::nc::stream_status_message, web::json::value::string(initial_status_message), gate);
        ...
        BST_CHECK_EQUAL(initial_status, actual_value.as_integer());
        const auto actual_status_message = nmos::nc::get_control_protocol_property(resources, monitor_oid, nmos::fields::nc::stream_status_message, gate);

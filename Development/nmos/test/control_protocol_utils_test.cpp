...
BST_TEST_CASE(testGetSetControlProtocolProperty)
{
	...
	auto oid = nmos::get_control_protocol_property(resources, class_manager_oid, nmos::nc_object_oid_property_id, control_protocol_state, get_control_protocol_class_descriptor, gate);

	BST_CHECK_EQUAL(class_manager_oid, static_cast<uint32_t>(oid.as_integer()));

	auto role = get_control_protocol_property(resources, class_manager_oid, nmos::nc_object_role_property_id, control_protocol_state, get_control_protocol_class_descriptor, gate);

	BST_CHECK_EQUAL(U("ClassManager"), role.as_string());

    auto test_label = U("ThisIsATest");

	bool result = set_control_protocol_property(resources, class_manager_oid, nmos::nc_object_user_label_property_id, web::json::value::string(test_label), control_protocol_state, get_control_protocol_class_descriptor, gate);

	BST_REQUIRE(result);

	auto label = get_control_protocol_property(resources, class_manager_oid, nmos::nc_object_user_label_property_id, control_protocol_state, get_control_protocol_class_descriptor, gate);
...
BST_TEST_CASE(testSetReceiverMonitorStatuses)
{
...

    {
        ...
        auto actual_link_status = get_control_protocol_property(resources, monitor_oid, nmos::nc_receiver_monitor_link_status_property_id, control_protocol_state, get_control_protocol_class_descriptor, gate);
        BST_CHECK_EQUAL(link_status, actual_link_status.as_integer());
        auto actual_link_status_message = get_control_protocol_property(resources, monitor_oid, nmos::nc_receiver_monitor_link_status_message_property_id, control_protocol_state, get_control_protocol_class_descriptor, gate);
        BST_CHECK_EQUAL(link_status_message, actual_link_status_message.as_string());
        auto actual_connection_status = get_control_protocol_property(resources, monitor_oid, nmos::nc_receiver_monitor_connection_status_property_id, control_protocol_state, get_control_protocol_class_descriptor, gate);
        BST_CHECK_EQUAL(connection_status, actual_connection_status.as_integer());
        auto actual_connection_status_message = get_control_protocol_property(resources, monitor_oid, nmos::nc_receiver_monitor_connection_status_message_property_id, control_protocol_state, get_control_protocol_class_descriptor, gate);
        BST_CHECK_EQUAL(connection_status_message, actual_connection_status_message.as_string());
        auto actual_external_synchronization_status = get_control_protocol_property(resources, monitor_oid, nmos::nc_receiver_monitor_external_synchronization_status_property_id, control_protocol_state, get_control_protocol_class_descriptor, gate);
        BST_CHECK_EQUAL(external_synchronization_status, actual_external_synchronization_status.as_integer());
        auto actual_external_synchronization_status_message = get_control_protocol_property(resources, monitor_oid, nmos::nc_receiver_monitor_external_synchronization_status_message_property_id, control_protocol_state, get_control_protocol_class_descriptor, gate);
        BST_CHECK_EQUAL(external_synchronization_status_message, actual_external_synchronization_status_message.as_string());
        auto actual_stream_status = get_control_protocol_property(resources, monitor_oid, nmos::nc_receiver_monitor_stream_status_property_id, control_protocol_state, get_control_protocol_class_descriptor, gate);
        BST_CHECK_EQUAL(stream_status, actual_stream_status.as_integer());
        auto actual_stream_status_message = get_control_protocol_property(resources, monitor_oid, nmos::nc_receiver_monitor_stream_status_message_property_id, control_protocol_state, get_control_protocol_class_descriptor, gate);
        BST_CHECK_EQUAL(stream_status_message, actual_stream_status_message.as_string());

        auto overall_status = get_control_protocol_property(resources, monitor_oid, nmos::nc_status_monitor_overall_status_property_id, control_protocol_state, get_control_protocol_class_descriptor, gate);

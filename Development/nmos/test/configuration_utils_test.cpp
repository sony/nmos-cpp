...
BST_TEST_CASE(testApplyBackupDataSet)
{
    ...
    }
    {
        ...
        auto property_holders = value::array();
        // This is a read only property
        push_back(property_holders, nmos::nc::details::make_property_holder(nmos::nc_receiver_monitor_connection_status_message_property_id, connection_status_property_descriptor, value(U("change this value"))));
...
BST_TEST_CASE(testFindMembersByClassId)
{
    ...
    auto exmaple_1 = make_example_block_resource(example_class_id_1, ++oid, nmos::root_block_oid, U("example block 1"), U("Example Block 1"), U("Example Block 1"));
    auto exmaple_2 = make_example_worker_resource(example_class_id_2, ++oid, nmos::root_block_oid, U("example block 2"), U("Example Block 2"), U("Example Block 2"));

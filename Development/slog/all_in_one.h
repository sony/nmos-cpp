...
// Generated at r338; to be truly free of dependencies, define SLOG_DETAIL_PROVIDES_UNIQUE_PTR_BASED_OPTIONAL and probably SLOG_STATIC
////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////
// Amalgamating: #include "slog/detail/private_access.h"
#ifndef SLOG_DETAIL_PRIVATE_ACCESS_H
#define SLOG_DETAIL_PRIVATE_ACCESS_H
...
#ifdef SLOG_DETAIL_PRIVATE_ACCESS_DEMO
#include <ostream>
...
// Amalgamated: #include "slog/detail/private_access.h" // for stow_private
#endif
...
namespace slog
{
    ...
    namespace detail
    {
        ...
        template struct stow_private<ios_base_xindex, &std::ios_base::__xindex_>;

        inline void init_stash(std::ios_base& ios)
        {
            const int xindex = *stowed<ios_base_xindex>::value;

...
int main(int argc, char* argv[])
{
    ...
    try
    {
        ...
        {
            error_log_buf.open(nmos::fields::error_log(node_model.settings), std::ios_base::app);
        ...
        {
            access_log_buf.open(nmos::fields::access_log(node_model.settings), std::ios_base::app);
            auto lock = log_model.write_lock();

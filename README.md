...
|----------|----------------------------------------------|------------------------------------|--------------------------------------------------------------------|
| Linux    | Ubuntu 22.04 (GCC 11.2.0) (No Authorization) | Avahi                              | Secure Communications<br/>Multicast DNS-SD                         |
...
| Windows  | Server 2022 (VS 2022) (No Authorization)     | Bonjour (mDNSResponder), ASIO      | Secure Communications<br/>Multicast DNS-SD                         |

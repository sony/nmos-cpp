...
2. Install or upgrade Conan using `pip install --upgrade conan~=2.20.1`
   Notes:
   - On some platforms with Python 2 and Python 3 both installed this may need to be `pip3 install --upgrade conan~=2.20.1`
